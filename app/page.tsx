        ...
        >
          ...
          <div className="flex flex-col lg:flex-row gap-4 lg:gap-6 justify-center items-center px-4">
            ...
            <Button
              size="lg"
              variant="outline"
              className="border-purple-300/50 bg-gradient-to-r from-purple-500/10 to-teal-500/10 text-white hover:from-purple-500/20 hover:to-teal-500/20 font-semibold text-sm lg:text-xl px-6 lg:px-12 py-4 lg:py-6 rounded-full backdrop-blur-xl"
              onClick={() => setIsChatOpen(true)}
            >
              <Bot className="w-5 h-5 lg:w-6 lg:h-6 mr-2 lg:mr-3" />
